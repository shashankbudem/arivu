...
const desktopApi = {
  ...
  queuePrompt: (prompt: unknown) => ipcRenderer.invoke("agent:queuePrompt", prompt),
  steerQueuedPrompt: (promptId: string) => ipcRenderer.invoke("agent:steerQueuedPrompt", promptId),
  ...
  toggleBrowserPaneOpen: () => ipcRenderer.invoke("browser:togglePaneOpen"),
