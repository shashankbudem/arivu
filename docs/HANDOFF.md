...
- Deepen the first TypeScript diagnostic layer into broader language-server evidence, including non-TypeScript diagnostics and open-file actions from diagnostic locations.
