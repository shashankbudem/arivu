...
- Add stronger semantic plan matching from richer artifacts such as LSP diagnostics beyond the current completion-note checklist and model-authored evidence labels.
