...
15. Confirm parsed report results and TypeScript diagnostic results show compact open-report/source buttons, and that clicking one opens only the attached evidence path from the session/worktree root.
